...
class JustAudioMediaKit extends JustAudioPlatform {
  ...
  /// Prefer WASAPI output on Windows.
  ///
  /// Default: `true`
  static bool preferWasapi = true;

  /// Prefer WASAPI exclusive mode on Windows.
  ///
  /// If exclusive mode cannot be applied, implementation may fall back to shared mode.
  ///
  /// Default: `true`
  static bool preferWasapiExclusive = true;

  /// Whether to fallback to WASAPI shared mode when exclusive mode fails.
  ///
  /// Default: `true`
  static bool fallbackToWasapiShared = true;

  /// Extra native mpv properties applied on player initialization.
  ///
