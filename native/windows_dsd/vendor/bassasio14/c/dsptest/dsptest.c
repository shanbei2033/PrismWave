				...
				case 10:
					{
						...
						if (GetOpenFileName(&ofn)) {
							...
							if (!(chan = BASS_StreamCreateFile(0, file, 0, 0, BASS_SAMPLE_LOOP | BASS_SAMPLE_FLOAT | BASS_STREAM_DECODE))
								&& !(chan = BASS_MusicLoad(0, file, 0, 0, BASS_MUSIC_LOOP | BASS_MUSIC_RAMPS | BASS_SAMPLE_FLOAT | BASS_STREAM_DECODE, 0))) {
